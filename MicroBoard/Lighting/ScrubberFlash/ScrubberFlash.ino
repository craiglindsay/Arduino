...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(1, PINE, NEO_GRB + NEO_KHZ800);// #define 32 LEDs for strip
Adafruit_NeoPixel stripLogic = Adafruit_NeoPixel(1, PINL, NEO_GRB + NEO_KHZ800);// #define 16 LEDs for strip
...
void setPixel(int Pixel, byte red, byte green, byte blue) {
   ...
   stripLogic.setPixelColor(Pixel, strip.Color(255-red, green, blue));
}
