...
Adafruit_NeoPixel strip = Adafruit_NeoPixel(27, PINE, NEO_GRB + NEO_KHZ800);// #define 32 LEDs for strip
...
void loop() {
     ...
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),4,3); // Turn 1st part red
     strip.show();
     fun = 100;      
     }
	 if (fun == 28 ) // S
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),3,5); // Turn 2nd part red
     strip.show();
     fun = 100;      
     }
	 if (fun == 29 ) // T
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),2,8); // Turn 2nd part red
     strip.show();
     fun = 100;  
     }
	 if (fun == 30 ) // U
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),1,10); // Turn 2nd half red
     strip.show();
     fun = 100;  
     }	 
	 if (fun == 31 ) // V
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),0,14); // Turn 2nd part red
     strip.fill(strip.Color(255,0,0),26,1); // Turn 2nd part red
     strip.show();
     fun = 100;  
     }	 
	 if (fun == 32 ) // W
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),0,16); // Turn 2nd part red
     strip.fill(strip.Color(255,0,0),24,3); // Turn 2nd part red
     strip.show();
     fun = 100;  
     }	 
	 if (fun == 33 ) // X
     {
     strip.fill(strip.Color(255,255,255),0,27); // Turn white
     strip.fill(strip.Color(255,0,0),0,18); // Turn 2nd part red
     strip.fill(strip.Color(255,0,0),22,5); // Turn 2nd part red
     strip.show();
     fun = 100;  
     }	 
	 if (fun == 34 ) // Y
     ...
     {
     int i = 60;
     strip.fill(strip.Color(255, 255, 255),0,27); // Turn 
     strip.show();
     delay(i);
     ...
     delay(i);
     strip.fill(strip.Color(255, 255, 255),0,27); // Turn Red
     strip.fill(strip.Color(255,0, 0),0,14); // Turn 2nd part white
