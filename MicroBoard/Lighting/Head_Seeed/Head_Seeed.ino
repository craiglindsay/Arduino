...
#define PINE 5      // Eye
#define PINL 6      // Logic
#define PINF8 D7     // Front 8 segment riser
#define PINF3 D8     // Front 3 segment riser
#define PINB3 D9     // Back 3 segment riser
#define NUM_LEDS 32
// ------------------------------------------
...
void setup() {
  fun = 0;
  mySerial.begin(115200);     // Hardware serial for receiving from B2's mega
